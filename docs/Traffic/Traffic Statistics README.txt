############################################################
README file for Traffic Statistics module of Real-Time 
...
This module uses the IPTraf program to generate statistics on network traffic between three specified subnets.  These subnets are hard-coded so modifying them requires changing the source
for this module


Installation:

The necessary components for installation on a Debian system:
...
For any other systems, check the system documentation to see how to install these dependencies. 
